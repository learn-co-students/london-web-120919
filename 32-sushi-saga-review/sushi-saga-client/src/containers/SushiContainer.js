...
const SushiContainer = ({ sushis, increaseSushiIndex, eatSushi, eatenSushis }) => {
  ...
  return (
    <Fragment>
      <div className="belt">
        {renderSushis()}
        { /* Pass down the function to increase the state of sushiIndex even further down the component tree as a prop  */}
